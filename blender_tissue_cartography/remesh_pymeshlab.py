# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04b_remeshing_pymeshlab.ipynb.

# %% auto 0
__all__ = ['subdivide_pymeshlab', 'simplify_pymeshlab', 'remesh_pymeshlab']

# %% ../nbs/04b_remeshing_pymeshlab.ipynb 2
from . import mesh as tcmesh
from . import tcio as tcio
...
# %% ../nbs/04b_remeshing_pymeshlab.ipynb 5
...
# %% ../nbs/04b_remeshing_pymeshlab.ipynb 11
@tcio.deprecated
def simplify_pymeshlab(mesh, targetfacenum, qualitythr=0.3, tempfilename="temp.obj", reglue=False, decimals=None):
    ...
    if reglue:
        mesh_simplified = tcmesh.glue_seams(mesh_simplified, decimals=decimals)
