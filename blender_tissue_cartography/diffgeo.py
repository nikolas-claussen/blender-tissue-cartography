...
# %% auto 0
__all__ = ['compute_per_vertex_area_distortion', 'get_all_boundary_vertices', 'impute_boundary_values',
           'get_area_distortion_in_UV', 'compute_per_vertex_angle_distortion', 'compute_per_face_jacobian',
           'compute_per_vertex_jacobian', 'get_metric_norm', 'get_metric_angle', 'get_induced_metric', 'tri_grad',
           'get_normal_projector', 'separate_tangential_normal', 'get_div', 'get_rot', 'get_grad_perp']
...
def get_all_boundary_vertices(tris):
    """Get list of all boundary vertices. Not guaranteed to be in any order"""
    return np.unique(igl.connect_boundary_to_infinity(tris)[tris.shape[0]:].flatten())
...
def impute_boundary_values(per_vertex_field, tris, fill_value=np.nan):
    ...
    """
    boundary_verts = get_all_boundary_vertices(tris)
