...
__all__ = ['deprecated', 'adjust_axis_order', 'subsample_image', 'normalize_quantiles', 'normalize_mean_std', 'write_h5',
           'read_h5', 'flatten', 'pad_list', 'unique', 'index_else_nan', 'invert_dictionary', 'ObjMesh',
           'read_other_formats_without_uv', 'glue_seams', 'marching_cubes', 'save_dict_to_json', 'save_for_imageJ',
...
class ObjMesh:
    ...
    def get_uv_matched_vertex_indices(self): # to do: rename
        """
        ...
        array -> array[self.get_uv_matched_vertex_indices()]
        """
