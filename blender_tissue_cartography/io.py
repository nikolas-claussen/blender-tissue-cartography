...
# %% auto 0
__all__ = ['adjust_axis_order', 'write_h5', 'read_h5', 'flatten', 'pad_list', 'ObjMesh', 'save_dict_to_json', 'save_for_imageJ',
...
class ObjMesh:
    ...
    def match_vertex_info(self):
        ...
        self.matched_vertices = np.stack([self.vertices[ix[0]] for ix in unique_v_vt_n_pairs])
