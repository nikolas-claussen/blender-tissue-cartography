...
def convert_to_open3d(mesh: tcio.ObjMesh, add_texture_info=None) -> o3d.t.geometry.TriangleMesh:
    ...
    if add_texture_info:
        mesh_o3d.triangle.texture_uvs =o3d.core.Tensor(np.stack([[mesh.texture_vertices[v] for v in tri]
                                                                 for tri in mesh.texture_tris]), dtype_f)
    return mesh_o3d

# %% ../nbs/01c_interface_open3d.ipynb 15
