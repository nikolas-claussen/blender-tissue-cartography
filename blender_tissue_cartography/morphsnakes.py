# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/Python library/01e_morphsnakes.ipynb.

# %% auto #0
__all__ = ['sup_inf', 'inf_sup', 'circle_level_set', 'ellipsoid_level_set', 'checkerboard_level_set', 'inverse_gaussian_gradient',
           'morphological_chan_vese', 'morphological_geodesic_active_contour']

# %% ../nbs/Python library/01e_morphsnakes.ipynb #ebb95073-0164-48ea-ac23-520d289aa8a9
""" This code is taken from https://github.com/pmneila/morphsnakes and is included in this repository for ease of installation. """
