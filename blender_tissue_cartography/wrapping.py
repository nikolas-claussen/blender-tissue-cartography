...
# %% auto 0
__all__ = ['get_uniform_laplacian', 'smooth_laplacian', 'smooth_laplacian_texture', 'smooth_taubin',
           'smooth_laplacian_on_surface', 'shrinkwrap_igl', 'transfer_per_vertex_attribute']
