  ...
  'syms': { 'blender_tissue_cartography.interpolation': { 'blender_tissue_cartography.interpolation.create_cartographic_projections': ( 'cartographic_interpolation.html#create_cartographic_projections',
            ...
            'blender_tissue_cartography.io': { 'blender_tissue_cartography.io.ObjMesh': ( 'io.html#objmesh',
                                               ...
                                               'blender_tissue_cartography.io.ObjMesh.__init__': ( 'io.html#objmesh.__init__',
                                                                                                   'blender_tissue_cartography/io.py'),
                                               'blender_tissue_cartography.io.ObjMesh._int_or_nan_to_str': ( 'io.html#objmesh._int_or_nan_to_str',
                                                                                                             'blender_tissue_cartography/io.py'),
                                               'blender_tissue_cartography.io.ObjMesh._str_to_int_or_nan': ( 'io.html#objmesh._str_to_int_or_nan',
                                                                                                             'blender_tissue_cartography/io.py'),
