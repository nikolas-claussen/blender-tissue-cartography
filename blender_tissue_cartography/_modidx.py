...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'blender_tissue_cartography.interface_open3d': { 'blender_tissue_cartography.interface_open3d.convert_to_open3d': ( 'interface_open3d.html#convert_to_open3d',
