...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'blender_tissue_cartography.analysis': { 'blender_tissue_cartography.analysis.compute_per_face_jacobian': ( 'analysis.html#compute_per_face_jacobian',
                                                     ...
                                                     'blender_tissue_cartography.analysis.get_area_distortion_in_UV': ( 'analysis.html#get_area_distortion_in_uv',
                                                                                                                        'blender_tissue_cartography/analysis.py'),
                                                     'blender_tissue_cartography.analysis.get_div': ( 'analysis.html#get_div',
                                                                                                      'blender_tissue_cartography/analysis.py'),
                                                     'blender_tissue_cartography.analysis.get_grad_perp': ( 'analysis.html#get_grad_perp',
                                                                                                            'blender_tissue_cartography/analysis.py'),
                                                     ...
                                                     'blender_tissue_cartography.analysis.get_metric_norm': ( 'analysis.html#get_metric_norm',
                                                                                                              'blender_tissue_cartography/analysis.py'),
                                                     'blender_tissue_cartography.analysis.get_normal_projector': ( 'analysis.html#get_normal_projector',
                                                                                                                   'blender_tissue_cartography/analysis.py'),
                                                     'blender_tissue_cartography.analysis.get_rot': ( 'analysis.html#get_rot',
                                                                                                      'blender_tissue_cartography/analysis.py'),
                                                     'blender_tissue_cartography.analysis.separate_tangential_normal': ( 'analysis.html#separate_tangential_normal',
                                                                                                                         'blender_tissue_cartography/analysis.py'),
