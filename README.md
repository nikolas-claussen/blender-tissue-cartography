...
1.  An add-on for the 3d creation software
    ...
    an interactive, graphical user interface (**Version 2** now
    available). Use the add-on to quickly process a new dataset, or if
    you are not a coding expert.
...
2.  A Python library for custom and automatized analysis pipelines. The
    ...
    source in [this GitHub
    directory](https://github.com/nikolas-claussen/blender-tissue-cartography/tree/main/blender_tissue_cartography).
...
2.  Create a `conda` environment and install the
    `blender_tissue_cartography` module:
