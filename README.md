...
![image.png](index_files/figure-commonmark/82a55c92-1-ee28c1cc-3737-4a46-b1ec-e96e9291126d.png)
...
![image.png](index_files/figure-commonmark/d26992e4-1-image.png)
...
With the Python library you can build automated and custom tissue
cartography pipelines. The library also has tools for quantitative image
analysis on projections (namely, to mathematically account for
...
the [Streichan lab at UCSB](https://streichanlab.physics.ucsb.edu/) (in
particular Susan Wopat and Matthew Lefebvre), Cecile Regis, Noah
Mitchell, An Yan, Dillon Cislo, and [the Irvine lab at
Rutgers](https://waksman.rutgers.edu/irvine) for feedback, sharing data,
